...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Country_info_Screen',
          path: '/countryInfoScreen',
          builder: (context, params) => CountryInfoScreenWidget(
            countryName: params.getParam('countryName', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'Search_Country_Screen',
          path: '/searchCountryScreen',
          builder: (context, params) => const SearchCountryScreenWidget(),
        ),
        FFRoute(
